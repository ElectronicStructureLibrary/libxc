...
/************************************************************************
 ...
 by 
   [1] J.P. Perdew & Y.Wang, Phys. Rev. B 45, 13244 (1992).
   [2] Ortiz & Ballone, PHys. Rev. B 50, 1391 (1994)
   [3] Ortiz & Ballone, PHys. Rev. B 56, 9970(E) (1997)
************************************************************************/
...
{
	double rs[3], decdrs;
	int func = p->functional - XC_LDA_C_PW;
