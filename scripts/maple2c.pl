...
sub math_replace {
  ...
  my @math_replace = (
    ...
    qr/pow\((.*?),  0.10e1\)/,         q{"($1)"},
    qr/pow\((.*?), -0.10e1\)/,         q{"0.1e1/($1)"},
    qr/pow\((.*?),  0.15e1\)/,         q{"POW_3_2($1)"},
    qr/pow\((.*?), -0.15e1\)/,         q{"0.1e1/POW_3_2($1)"},
    qr/pow\((.*?),  0.20e1\)/,         q{"POW_2($1)"},
    qr/pow\((.*?), -0.20e1\)/,         q{"0.1e1/POW_2($1)"},
    qr/pow\((.*?),  0.30e1\)/,         q{"POW_3($1)"},
    qr/pow\((.*?), -0.30e1\)/,         q{"0.1e1/POW_3($1)"},
    ...
    qr/pow\((.*?),  0.99999999999999999999e0\)/, q{"($1)"},
    qr/pow\((.*?),  0.10000000000000000000e1\)/, q{"($1)"},
    qr/pow\((.*?), -0.99999999999999999999e0\)/, q{"0.1e1/($1)"},  
    qr/pow\((.*?), -0.10000000000000000000e1\)/, q{"0.1e1 / ($1)"},
    qr/pow\((.*?),  0.6666666666666666667e0\)/,  q{"POW_2_3($1)"},
    qr/pow\((.*?), -0.6666666666666666667e0\)/,  q{"0.1e1 / POW_2_3($1)"},
    qr/pow\((.*?),  0.33333333333333333333e0\)/, q{"POW_1_3($1)"},
    qr/pow\((.*?),  0.33333333333333333334e0\)/, q{"POW_1_3($1)"},
    qr/pow\((.*?), -0.33333333333333333333e0\)/, q{"0.1e1 / POW_1_3($1)"},
    qr/pow\((.*?), -0.33333333333333333334e0\)/, q{"0.1e1 / POW_1_3($1)"},
    qr/pow\((.*?),  0.16666666666666666666e1\)/, q{"POW_5_3($1)"},
    qr/pow\((.*?),  0.16666666666666666667e1\)/, q{"POW_5_3($1)"},
    qr/pow\((.*?), -0.16666666666666666666e1\)/, q{"0.1e1 / POW_5_3($1)"},
    qr/pow\((.*?), -0.16666666666666666667e1\)/, q{"0.1e1 / POW_5_3($1)"},
    qr/pow\((.*?),  0.23333333333333333333e1\)/, q{"POW_7_3($1)"},
    qr/pow\((.*?),  0.23333333333333333334e1\)/, q{"POW_7_3($1)"},
    qr/pow\((.*?), -0.23333333333333333333e1\)/, q{"0.1e1 / POW_7_3($1)"},
    qr/pow\((.*?), -0.23333333333333333334e1\)/, q{"0.1e1 / POW_7_3($1)"},
