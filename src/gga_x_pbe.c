...
const XC(func_info_type) XC(func_info_gga_x_pbe) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevLett_77_3865, &xc_ref_PhysRevLett_78_1396, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_x_pbe_r) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevLett_80_890, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init, 
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_pbe_sol) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevLett_100_136406, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init, 
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_xpbe) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_121_9_10_1063_1_1771632, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init, 
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_pbe_jsjr) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevB_79_201106, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init, 
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_pbek1_vdw) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_0953_8984_22_2_022201, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init, 
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_rge2) = {
  ...
  "Regularized PBE",
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_ct8005369, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_apbe) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevLett_106_186406, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_pbeint) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevB_82_113104, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
...
const XC(func_info_type) XC(func_info_gga_x_pbe_tca) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_Tognetti2008536, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_k_tw1) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_QUA_QUA10306, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_k_apbeint) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_ct200382w, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_pbe_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_x_pbe_mol) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_136_10_10_1063_1_3691197, NULL, NULL, NULL, NULL},
