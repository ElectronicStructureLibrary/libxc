...
const XC(func_info_type) XC(func_info_gga_x_vmt_pbe) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_130_24_10_1063_1_3152713, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_x_vmt84_pbe) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_136_14_10_1063_1_3701132, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_vmt_init, 
  NULL, NULL,
