...
const XC(func_info_type) XC(func_info_gga_xc_b97) = {
  ...
  "Becke 97",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_107_20_10_1063_1_475007, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_xc_b97_1) = {
  ...
  "Becke 97-1",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_109_15_10_1063_1_477267, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init,
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_b97_2) = {
  ...
  "Becke 97-2",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_115_20_10_1063_1_1412605, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_b97_d) = {
  ...
  "Becke 97-D",
  XC_FAMILY_GGA,
  {&xc_ref_JCC_JCC20495, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_b97_k) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_121_8_10_1063_1_1774975, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_b97_3) = {
  ...
  "Becke 97-3",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_123_12_10_1063_1_2061227, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_hcth_120) = {
  ...
  "HCTH/120",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_112_4_10_1063_1_480732, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_hcth_407) = {
  ...
  "HCTH/407",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_114_13_10_1063_1_1347371, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_sb98_1a) = {
  ...
  "SB98 (1a)",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_108_23_10_1063_1_476438, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_b97_gga1) = {
  ...
  "Becke 97 GGA-1",
  XC_FAMILY_GGA,
  {&xc_ref_Cohen2000160, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_hcth_p14) = {
  ...
  "HCTH p=1/4",
  XC_FAMILY_GGA, 
  {&xc_ref___content_aip_journal_jcp_114_9_10_1063_1_1342776, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
const XC(func_info_type) XC(func_info_gga_xc_hcth_407p) = {
  ...
  "HCTH/407+",
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_119_12_10_1063_1_1599338, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-23, 1e-32, 0.0, 1e-32,
  gga_xc_b97_init, 
  NULL,
...
XC(func_info_type) XC(func_info_gga_c_n12) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_ct3002656, NULL, NULL, NULL, NULL},
