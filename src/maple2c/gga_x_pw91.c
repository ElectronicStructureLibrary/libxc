  ...
  (const XC(func_type) *p,  XC(gga_work_x_t) *r)
{
  ...
  t5 = params->d * t4;
  t6 = params->c + t5;
  t10 = pow(0.12827824385304219430e0 * r->x, params->expo);
  t11 = params->f * t10;
  t12 = 0.16455307846020557507e-1 * t6 * t1 - t11;
  t13 = r->x * params->a;
  t16 = log(0.12827824385304219430e0 * params->b * r->x + sqrt(pow(0.12827824385304219430e0 * params->b * r->x, 0.2e1) + 0.1e1));
  ...
  t23 = t1 * r->x;
  t24 = t23 * t4;
  t32 = 0.10000000000000000000e1 * t11 * params->expo / r->x;
  t33 = -0.54155431261461143986e-3 * t22 * t24 + 0.32910615692041115014e-1 * t6 * r->x - t32;
  t35 = t19 * t19;
  t36 = 0.1e1 / t35;
  t37 = t12 * t36;
  ...
  r->d2fdx2 = t70 * t20 - t37 * t91 - 0.2e1 * t72 * t49 + 0.2e1 * t77 * t78;
  ...
  t139 = t40 * t40;
  t141 = t43 * t43;
  r->d3fdx3 = (-0.64986517513753372783e-2 * t22 * r->x * t4 + 0.16040597272944273733e-3 * t55 * t24 - 0.58656214702296859059e-6 * params->d * t54 * params->alpha * t56 * r->x * t4 - t108 + t111 - t114) * t20 - 0.3e1 * t70 * t36 * t49 + 0.6e1 * t33 * t76 * t78 - 0.3e1 * t72 * t91 - 0.6e1 * t12 / t125 * t78 * t49 + 0.6e1 * t77 * t49 * t91 - t37 * (-0.10831086252292228797e-2 * params->a * t85 * t87 * r->x + 0.13367164394120228111e-4 * t23 * params->a * t139 * params->b / t44 / t141 + t108 - t111 + t114);
