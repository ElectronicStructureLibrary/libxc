...
func_pol(const xc_func_type *p, int order, const double *rho, const double *sigma, double *zk, double *vrho, double *vsigma, double *v2rho2, double *v2rhosigma, double *v2sigma2, double *v3rho3, double *v3rho2sigma, double *v3rhosigma2, double *v3sigma3)
{
  ...
  t802 = t477 - t282 + t306 - t311 - t314 / 0.2e1 - t329 - t338 - t343 - t216 - t372 + t9 * (t743 + t799);
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[3] = -t278 - t301 - t322 / 0.2e1 - t333 / 0.2e1 + t475 + t477 - 0.3e1 / 0.4e1 * t314 - 0.3e1 / 0.2e1 * t328 - 0.3e1 * t338 - 0.3e1 / 0.2e1 * t342 - 0.9e1 / 0.8e1 * t371 + t9 * (-t509 - t521 + t621 / 0.4e1 - 0.3e1 / 0.8e1 * t721 - t7 * t70 * t38 * t813 / 0.2e1 - t7 * t249 * t147 * t330 / 0.2e1 - 0.3e1 / 0.2e1 * t7 * t108 * t369 * t126 - 0.3e1 / 0.2e1 * t7 * t108 * t147 * t339 + t7 * t108 * t64 * t813 / 0.2e1 - 0.3e1 / 0.8e1 * t7 * t45 * (-0.6688e4 / 0.27e2 * t19 * t46 / t50 / t138 * t61 + 0.25504e5 / 0.27e2 * t93 * t137 / t426 * t143 - 0.1152e4 * t232 * t359 / t55 / t846 * t365 + 0.4096e4 / 0.9e1 * t548 * t359 * sigma[2] / t50 / t854 * t859) + t892);
