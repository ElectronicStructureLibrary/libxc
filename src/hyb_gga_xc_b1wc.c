...
const XC(func_info_type) XC(func_info_hyb_gga_xc_b1wc) = {
  ...
  "B1WC",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_PhysRevB_77_165107, NULL, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_b1lyp) = {
  ...
  "B1LYP",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_Adamo1997242, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_mpw1k) = {
  ...
  "mPW1K",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_doi_10_1021_jp000497z, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_bhandh) = {
  ...
  "BHandH",
  XC_FAMILY_HYB_GGA,
  {&xc_ref___content_aip_journal_jcp_98_2_10_1063_1_464304, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
