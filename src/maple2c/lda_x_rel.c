...
func0(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  t22 = t21 * t14;
  t26 = t3 * t3;
  t30 = log(0.26719108327908265315e-2 * t13 * t26 * t11 + sqrt(pow(0.26719108327908265315e-2 * t13 * t26 * t11, 0.2e1) + 0.1e1));
  t31 = t30 * t13;
...
func1(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  t29 = t28 * t21;
  t33 = t3 * t3;
  t37 = log(0.26719108327908265315e-2 * t20 * t33 * t19 + sqrt(pow(0.26719108327908265315e-2 * t20 * t33 * t19, 0.2e1) + 0.1e1));
  t38 = t37 * t20;
