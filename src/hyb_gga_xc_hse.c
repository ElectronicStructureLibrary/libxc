...
const XC(func_info_type) XC(func_info_hyb_gga_xc_hse03) = {
  ...
  "HSE03",
  XC_FAMILY_HYB_GGA,
  {&xc_ref___content_aip_journal_jcp_118_18_10_1063_1_1564060, &xc_ref___content_aip_journal_jcp_124_21_10_1063_1_2204597, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_hse06) = {
  ...
  "HSE06",
  XC_FAMILY_HYB_GGA,
  {&xc_ref___content_aip_journal_jcp_118_18_10_1063_1_1564060, &xc_ref___content_aip_journal_jcp_124_21_10_1063_1_2204597, &xc_ref___content_aip_journal_jcp_125_22_10_1063_1_2404663, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC,
  1e-32, 1e-32, 0.0, 1e-32,
  hyb_gga_xc_hse_init,
  NULL, NULL, NULL, NULL
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_hjs_pbe) = {
  ...
  XC_FAMILY_HYB_GGA,
  {&xc_ref___content_aip_journal_jcp_128_19_10_1063_1_2921797, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HYB_CAM | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC,
  1e-32, 1e-32, 0.0, 1e-32,
  hyb_gga_xc_hjs_init,
  NULL, NULL, NULL, NULL
