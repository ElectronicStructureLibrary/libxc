...
const XC(func_info_type) XC(func_info_gga_xc_edf1) = {
  ...
  "EDF1",
  XC_FAMILY_GGA,
  {&xc_ref_Adamson19986, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_xc_mohlyp) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_jp0539223, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_xc_mohlyp_init,
  NULL, NULL, NULL, NULL
...
const XC(func_info_type) XC(func_info_gga_xc_mohlyp2) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_ct800568m, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_xc_mohlyp2_init,
  NULL, NULL, NULL, NULL
...
const XC(func_info_type) XC(func_info_gga_x_sogga) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref___content_aip_journal_jcp_128_18_10_1063_1_2912068, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
