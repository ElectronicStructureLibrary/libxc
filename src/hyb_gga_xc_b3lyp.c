...
const XC(func_info_type) XC(func_info_hyb_gga_xc_b3pw91) = {
  ...
  XC_FAMILY_HYB_GGA,
  {&xc_ref___content_aip_journal_jcp_98_7_10_1063_1_464913, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_b3lyp) = {
  ...
  "B3LYP",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_doi_10_1021_j100096a001, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_mb3lyp_rc04) = {
  ...
  "B3LYP with RC04 LDA",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_Tognetti2007381, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
...
const XC(func_info_type) XC(func_info_hyb_gga_xc_revb3lyp) = {
  ...
  "Revised B3LYP",
  XC_FAMILY_HYB_GGA,
  {&xc_ref_Lu201364, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
