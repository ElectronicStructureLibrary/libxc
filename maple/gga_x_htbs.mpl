...
cc0 :=  s1^3*(s1^2 - 5.0*s1*s2 + 10*s2^2)/(s1 - s2)^5:
cc1 := -30.0*s1^2*s2^2/(s1 - s2)^5:
cc2 :=  30.0*s1*s2*(s1 + s2)/(s1 - s2)^5:
cc3 := -10.0*(s1^2 + 4.0*s1*s2 + s2^2)/(s1 - s2)^5:
cc4 :=  15.0*(s1 + s2)/(s1 - s2)^5:
cc5 := -6.0/(s1 - s2)^5:
