...
const XC(func_info_type) XC(func_info_gga_x_b88) = {
  ...
  "Becke 88",
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevA_38_3098, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_x_mb88) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_doi_10_1021_jp903672e, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_b88_init, 
  NULL, 
...
const XC(func_info_type) XC(func_info_gga_k_llp) = {
  ...
  "Becke 88",
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevA_44_768, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_b88_init,
  NULL,
...
const XC(func_info_type) XC(func_info_gga_k_fr_b88) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_Fuentealba199531, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_b88_init,
  NULL,
...
const XC(func_info_type) XC(func_info_gga_k_thakkar) = {
  ...
  "Thakkar 1992",
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevA_46_6920, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC | XC_FLAGS_HAVE_KXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_x_b88_init,
  NULL,
