  ...
  (const XC(func_type) *p,  XC(gga_work_x_t) *r)
{
  ...
  t53 = 0.1e1 / t28 / t4;
  r->d3fdx3 = -0.24e2 * t18 * params->omega * params->gamma * r->x * t14 - 0.8e1 * t48 * t25 * params->omega * t50 * t53 - 0.24e2 * t48 * t25 * t50 * t53 - 0.16e2 * t48 * params->omega * t50 * t53 + 0.36e2 * t12 * t30 + 0.36e2 * t12 * t34;
