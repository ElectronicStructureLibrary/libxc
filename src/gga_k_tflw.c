...
#define XC_GGA_K_LGOPT         635 /* empirically optimized gamma-TFvW form */
...
static const double tfvw_lgopt_values[TFVW_N_PAR]  = {0.599, 0.697};
...
extern "C"
#endif
const xc_func_info_type xc_func_info_gga_k_lgopt = {
  XC_GGA_K_LGOPT,
  XC_KINETIC,
  ...
  XC_FLAGS_3D | MAPLE2C_FLAGS,
  1e-15,
  {TFVW_N_PAR, tfvw_names, tfvw_desc, tfvw_lgopt_values, set_ext_params_cpy},
  gga_k_tflw_init, NULL,
  NULL, work_gga, NULL
};
