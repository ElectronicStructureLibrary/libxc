...
func_fxc_unpol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_FXC(XC_COMMA double *, ))
{
  ...
  if(v2rho2 != NULL && (p->info->flags & XC_FLAGS_HAVE_FXC))
    v2rho2[0] += (0.1e2 / 0.27e2 * t8 * t15 / t16);
...
func_kxc_unpol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_KXC(XC_COMMA double *, ))
{
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[0] += (-0.1e2 / 0.81e2 * t8 * t15 / t16 / rho[0]);
...
func_lxc_unpol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_LXC(XC_COMMA double *, ))
{
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[0] += (0.4e2 / 0.243e3 * t8 * t15 / t16 / t28);
...
func_fxc_pol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_FXC(XC_COMMA double *, ))
{
  ...
  if(v2rho2 != NULL && (p->info->flags & XC_FLAGS_HAVE_FXC))
    v2rho2[0] += (0.1e2 / 0.9e1 * t72 + t77 + t38 * t101 * t54 / 0.3e1);
  ...
  if(v2rho2 != NULL && (p->info->flags & XC_FLAGS_HAVE_FXC))
    v2rho2[2] += (0.1e2 / 0.9e1 * t108 + t77 + t38 * t150 * t54 / 0.3e1);
...
func_kxc_pol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_KXC(XC_COMMA double *, ))
{
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[0] += (0.5e1 / 0.3e1 * t156 + 0.1e2 / 0.9e1 * t158 - t164 + t38 * t196 * t54 / 0.3e1);
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[1] += (0.5e1 / 0.9e1 * t156 + 0.2e2 / 0.27e2 * t158 - t164 + 0.1e2 / 0.27e2 * t204 + t208 + t38 * t240 * t54 / 0.3e1);
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[2] += (0.2e2 / 0.27e2 * t204 + t208 + 0.1e2 / 0.27e2 * t158 - t164 + 0.5e1 / 0.9e1 * t247 + t38 * t278 * t54 / 0.3e1);
  ...
  if(v3rho3 != NULL && (p->info->flags & XC_FLAGS_HAVE_KXC))
    v3rho3[3] += (0.1e2 / 0.9e1 * t204 + 0.5e1 / 0.3e1 * t247 - t164 + t38 * t306 * t54 / 0.3e1);
...
func_lxc_pol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_LXC(XC_COMMA double *, ))
{
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[0] += (0.2e2 / 0.9e1 * t312 + 0.2e2 / 0.9e1 * t314 - 0.4e2 / 0.81e2 * t316 + t322 + t38 * (t345 / 0.2e1 + t364 / 0.2e1) * t54 / 0.3e1);
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[1] += (0.5e1 / 0.9e1 * t312 + 0.1e2 / 0.9e1 * t314 - 0.1e2 / 0.27e2 * t316 + t322 - 0.1e2 / 0.81e2 * t375 + t379 + 0.5e1 / 0.3e1 * t381 + t38 * (t409 / 0.2e1 + t436 / 0.2e1) * t54 / 0.3e1);
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[2] += (-0.2e2 / 0.81e2 * t375 + 0.4e2 / 0.27e2 * t378 + 0.1e2 / 0.9e1 * t381 + 0.1e2 / 0.27e2 * t314 - 0.2e2 / 0.81e2 * t316 + t322 + 0.1e2 / 0.27e2 * t448 + 0.1e2 / 0.9e1 * t451 + t38 * (t481 / 0.2e1 + t507 / 0.2e1) * t54 / 0.3e1);
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[3] += (-0.1e2 / 0.27e2 * t375 + t379 + 0.1e2 / 0.9e1 * t448 + 0.5e1 / 0.3e1 * t451 - 0.1e2 / 0.81e2 * t316 + t322 + 0.5e1 / 0.9e1 * t518 + t38 * (t542 / 0.2e1 + t563 / 0.2e1) * t54 / 0.3e1);
  ...
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[4] += (-0.4e2 / 0.81e2 * t375 + 0.2e2 / 0.9e1 * t448 + 0.2e2 / 0.9e1 * t518 + t322 + t38 * (t587 / 0.2e1 + t602 / 0.2e1) * t54 / 0.3e1);
