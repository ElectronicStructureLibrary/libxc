/* 
  ...
  Maple source      : ../maple/lda_k_zlp1.mpl
...
func0(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  r->zk = 0.20081986091395377340e1 * t2 * t9;
...
func1(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  r->zk = 0.20081986091395377340e1 * t10 * t17;
...
void 
XC(lda_k_zlp1_func)(const XC(func_type) *p, XC(lda_work_t) *r)
{
...
#define maple2c_func  XC(lda_k_zlp1_func)
