...
const XC(func_info_type) XC(func_info_mgga_x_br89) = {
  ...
  "Becke-Roussel 89",
  XC_FAMILY_MGGA,
  {&xc_ref_PhysRevA_39_3761, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_mgga_x_bj06) = {
  ...
  "Becke & Johnson 06",
  XC_FAMILY_MGGA,
  {&xc_ref___content_aip_journal_jcp_124_22_10_1063_1_2213970, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_mgga_x_tb09) = {
  ...
  "Tran & Blaha 09",
  XC_FAMILY_MGGA,
  {&xc_ref_PhysRevLett_102_226401, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_VXC,
  MIN_DENS, MIN_GRAD, MIN_TAU, MIN_ZETA,
  mgga_x_tb09_init,
  NULL,
...
const XC(func_info_type) XC(func_info_mgga_x_rpp09) = {
  ...
  XC_FAMILY_MGGA,
  {&xc_ref___content_aip_journal_jcp_132_4_10_1063_1_3300063, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_VXC,
