/*
  ...
  Maple source      : lda_c_chachiyo.mpl
...
func_lxc_unpol(const xc_func_type *p, int order, const double *rho , double *zk LDA_OUT_PARAMS_LXC(XC_COMMA double *, ))
{
  ...
  t205 = t99 * t99;
  if(v4rho4 != NULL && (p->info->flags & XC_FLAGS_HAVE_LXC))
    v4rho4[0] += (0.4e1 * t123 - 0.12e2 * t125 + 0.8e1 * t131 + 0.4e1 * t151 + rho[0] * (t171 - t173 + t176 - t180 - t186 + (params->af * (-0.8e2 / 0.243e3 * t25 * t161 - 0.56e2 / 0.243e3 * t28 * t166) * t65 - 0.4e1 * t138 * t140 + 0.12e2 * t95 * t146 * t97 - 0.3e1 * params->af * t199 * t100 - 0.6e1 * params->af * t203 / t205 - t171 + t173 - t176 + t180 + t186) * t40 * t45));
