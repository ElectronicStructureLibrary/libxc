...
module XC_F90(lib_m)
  ...
  public ::                              &
    ...
    XC_F90(lda_c_2d_prm08_set_params),   &
    XC_F90(gga_init),                    &
    XC_F90(gga),                         &
    XC_F90(gga_exc),                     &
    XC_F90(gga_vxc),                     &
  ...
  interface
    subroutine XC_F90(lda_c_2d_prm08_set_params)(p, N)
      use XC_F90(types_m)
      type(XC_F90(func_t)), intent(inout)  :: p
      real(xc_f90_kind),    intent(in)     :: N
    end subroutine XC_F90(lda_c_2d_prm08_set_params)
  end interface
  ...
  interface
    subroutine XC_F90(hyb_gga_vxc)(p, rho, sigma, zk, vrho, vsigma)
      use XC_F90(types_m)
      type(XC_F90(func_t)), intent(in)  :: p
      real(xc_f90_kind),    intent(in)  :: rho
      real(xc_f90_kind),    intent(in)  :: sigma
