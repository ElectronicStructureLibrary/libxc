...
const XC(func_info_type) XC(func_info_gga_k_dk) = {
  ...
  "DePristo and Kress",
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevA_35_438, NULL, NULL, NULL, NULL},
...
const XC(func_info_type) XC(func_info_gga_k_perdew) = {
  ...
  "Perdew",
  XC_FAMILY_GGA,
  {&xc_ref_Perdew199279, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_k_dk_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_k_vsk) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevB_57_12611, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_k_dk_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_k_vjks) = {
  ...
  XC_FAMILY_GGA,
  {&xc_ref_PhysRevA_61_052511, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_k_dk_init,
  NULL, NULL,
...
const XC(func_info_type) XC(func_info_gga_k_ernzerhof) = {
  ...
  "Ernzerhof",
  XC_FAMILY_GGA,
  {&xc_ref_Ernzerhof200059, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 0.0, 1e-32,
  gga_k_dk_init,
  NULL, NULL,
