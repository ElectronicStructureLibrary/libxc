...
func0(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  t16 = 0.1e1 / t5;
  t18 = 0.1e1 / t4;
  r->f = -t1 * (t9 * t14 - t2 * t16 + 0.5e0 * r->rs * t18 - 0.33333333333333333333e0);
  ...
  t28 = 0.1e1 / t13;
  t29 = t4 * t28;
  r->dfdrs = -t1 * (0.3e1 * t2 * t7 * t14 - 0.10e1 * t9 * t26 * t29 - 0.2e1 * r->rs * t16 + 0.5e0 * t18);
  ...
  t50 = 0.1e1 / t49;
  t51 = t5 * t50;
  r->d2fdrs2 = -t1 * (0.6e1 * r->rs * t7 * t14 - 0.60e1 * t16 * t28 + 0.20e1 * t9 / t3 * t29 - 0.100e1 * t48 * t51 - 0.2e1 * t16);

  if(r->order < 3) return;

  r->d3fdrs3 = -t1 * (0.6e1 * t7 * t14 - 0.900e1 * t18 * t50 * t26 - 0.60e1 * t48 * t29 + 0.600e1 * t9 / t46 / r->rs * t51 - 0.2000e1 * t9 / t46 / t2 * t6 / t49 / t13);
...
func1(const XC(func_type) *p, XC(lda_work_t) *r)
{
  ...
  r->d3fdrs3 = -t150 + t29 * (-t30 * (0.6e1 * t34 * t40 - 0.900e1 * t44 * t115 * t54 - 0.60e1 * t113 * t70 + 0.600e1 * t36 * t137 * t116 - 0.2000e1 * t36 * t142 * t33 / t114 / t39) + t150);
  r->d3fdrs2z = t84 * t122;
  r->d3fdrsz2 = t128 * t78;
  t171 = pow(t23, -0.16666666666666666667e1);
  t173 = pow(t26, -0.16666666666666666667e1);
  r->d3fdz3 = (-0.56997364472045520586e0 * t171 + 0.56997364472045520586e0 * t173) * t49;
