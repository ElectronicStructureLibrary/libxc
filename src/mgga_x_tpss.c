...
XC(func_info_type) XC(func_info_mgga_x_modtpss) = {
  ...
  XC_FAMILY_MGGA,
  {&xc_ref_PhysRevA_76_042506, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 1e-32, 1e-32,
  mgga_x_tpss_init,
  NULL, NULL, NULL,
...
XC(func_info_type) XC(func_info_mgga_x_revtpss) = {
  ...
  XC_FAMILY_MGGA,
  {&xc_ref_PhysRevLett_103_026403, &xc_ref_PhysRevLett_106_179902, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 1e-32, 1e-32,
  mgga_x_tpss_init,
  NULL, NULL, NULL,
...
XC(func_info_type) XC(func_info_mgga_x_bloc) = {
  ...
  XC_FAMILY_MGGA,
  {&xc_ref_doi_10_1021_ct400148r, NULL, NULL, NULL, NULL},
  XC_FLAGS_3D | XC_FLAGS_HAVE_EXC | XC_FLAGS_HAVE_VXC | XC_FLAGS_HAVE_FXC,
  1e-32, 1e-32, 1e-32, 1e-32,
  mgga_x_tpss_init,
  NULL, NULL, NULL,
